...
namespace MVP.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Pobierz powiązane dane z tabeli History
            var userHistory = await _context.History
                .Where(h => h.UserName == user.UserName)
                .ToListAsync();

            // Usuń powiązane dane z tabeli History
            ...
            _logger.LogInformation("Użytkownik o ID '{UserId}' usunął siebie.", userId);
